...

{
  ...
  custom_project_badges: [
    {
      anchor: '[![Tests](https://github.com/Tatsh/re3-installer/actions/workflows/tests.yml/badge.svg)]',
      href: 'https://github.com/Tatsh/re3-installer/actions/workflows/tests.yml',
    },
    {
      anchor: '[![Coverage Status](https://coveralls.io/repos/github/Tatsh/re3-installer/badge.svg?branch=master)]',
      href: 'https://coveralls.io/github/Tatsh/re3-installer?branch=master',
    },
  ],
