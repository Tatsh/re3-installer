...
[![GitHub commits since latest release (by SemVer including pre-releases)](https://img.shields.io/github/commits-since/Tatsh/re3-installer/v0.2.6/master)](https://github.com/Tatsh/re3-installer/compare/v0.2.6...master)
...
[![pre-commit.ci status](https://results.pre-commit.ci/badge/github/Tatsh/re3-installer/master.svg)](https://results.pre-commit.ci/latest/github/Tatsh/re3-installer/master)
...
[releases](https://github.com/Tatsh/re3-installer/releases/tag/v0.2.6) page for this version of the
installer.
